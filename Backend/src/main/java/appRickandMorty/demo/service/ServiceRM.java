package appRickandMorty.demo.service;

import appRickandMorty.demo.models.*;
import appRickandMorty.demo.repositoy.EpisodeRepository;
...
public class ServiceRM {
    ...
    public ServiceRM(WebClient.Builder builder) {
